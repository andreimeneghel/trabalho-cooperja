...
try {
    ...
    //     SimpleRouter::match(
    //         ['get', 'post'],
    //         URL_ADMIN . 'posts/cadastrar',
    //         'AdminPosts@cadastrar'
    //     );
    //     SimpleRouter::match(
    //         ['get', 'post'],
    //         URL_ADMIN . 'posts/editar/{id}',
    //         'AdminPosts@editar'
    //     );
    //     SimpleRouter::get(
    //         URL_ADMIN . 'posts/deletar/{id}',
    //         'AdminPosts@deletar'
    //     );
    ...
    //     SimpleRouter::match(
    //         ['get', 'post'],
    //         URL_ADMIN . 'categorias/cadastrar',
    //         'AdminCategorias@cadastrar'
    //     );
    //     SimpleRouter::match(
    //         ['get', 'post'],
    //         URL_ADMIN . 'categorias/editar/{id}',
    //         'AdminCategorias@editar'
    //     );
    //     SimpleRouter::get(
    //         URL_ADMIN . 'categorias/deletar/{id}',
